...
final String email = 'Join Vible and see what Vible users have been up to!\n\n';

final holy_image =
    'https://assets.socialverseapp.com/categories/a6861bd94e900fe7b6a88b72fd1975ea';

final String invite_text =
    'I\'m $prefs_username on Vible. To download the app, click on the link below:\n\n';

final whatsapp =
    'https://wa.me/?text=Join Vible and see what Vible users have been up to!\n\n';

final whatsapp_invite = 'https://wa.me/?text=$invite_text';

final telegram_1 = 'https://telegram.me/share/url?url=';
final telegram_2 = '&text=Join Vible and see what Vible users have been up to!';
